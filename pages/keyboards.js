...
const keyboards = [
  ...
  {
    slug: "work-louder-creator-board",
    ...
    wireless: false,
    status: "available",
    bestFor: "Creators who want a desk statement piece",
    beginnerScore: 2,
    portabilityScore: 4,
    customizationScore: 4,
    recommendedRank: 11,
    highlights: ["Modular layout", "Low-profile", "Creative workflow", "Choc caps"],
    description:
      "The Creator Board leans into a unique modular design with low-profile switches, custom keycaps, and a distinctive layout built for creative shortcuts and macros.",
