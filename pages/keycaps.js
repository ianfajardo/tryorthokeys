              ...
              <div className="row align-items-center">
                <div className="col-lg-12">
                  <h2 className="font-weight-bold text-primary">
                    <a href="https://drop.com/?referer=T93XGG">Drop</a> Keycaps
                  </h2>
                  <p>
                    Drop offers keyboards, keycaps, audio peripherals on Amazon
                    and group buys on their websites.
                  </p>
                  <a
                  ...
                  <Table responsive striped bordered hover className="mt-3">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="https://kbdfans.com/r?id=84sm0h">View Now</a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="https://kbdfans.com/r?id=pu6bri">View Now</a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="https://kbdfans.com/r?id=2ea9io">View now</a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <a href="https://kbdfans.com/r?id=ikcq6d">View now</a>
                        </td>
                      </tr>
                    </tbody>
                  </Table>
            ...
            <div className="px-5 py-5">
              <div className="row align-items-center">
                <div className="col-lg-12">
                  ...
                  <p>
                    Assortment of ortholinear keycaps on Amazon, many of which
                    are from YMDK
                  </p>
                  ...
                  <Table responsive striped bordered hover className="mt-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>YMDK Carbon Laser-Etched Top Print OEM Keycap</td>
                        <td>OEM</td>
                        <td>
                          <a
