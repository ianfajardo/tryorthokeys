...
![QMK Configurator on an ortholinear layout](/qmk-configurator.png "QMK Configurator on an ortholinear layout")
...
[QMK Firmware](https://qmk.fm/) is the open-source firmware platform behind a huge number of mechanical and ortholinear keyboards. It is what makes boards like the [Planck and Preonic](/olkb) so flexible in the first place.
...
The tradeoff is that QMK asks more from you. Even when you use the [QMK Configurator](https://config.qmk.fm/), you are still dealing with firmware files, flashing, and a workflow that feels more technical than a simple settings panel.

## What VIA does well

[VIA](https://www.caniusevia.com/) is the option most beginners end up loving first. On supported keyboards, it gives you a visual way to remap keys without rebuilding firmware every time you want to change something.
...
If you already own a Planck or Preonic, our [configuration guide](/configure) is still the best place to start with flashing and layout basics. If you are still deciding what to buy, browse our [ortholinear keyboard list](/keyboards) and focus on boards that clearly mention QMK and VIA support.
